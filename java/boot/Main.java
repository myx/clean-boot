...
public final class Main {
	...
	public static void main(final String[] args) throws Throwable {
		...
		Main.initProperty( "ru.myx.ae3.properties.path.public", //
				pathCurrent.getAbsolutePath() );
		Main.initProperty( "ru.myx.ae3.properties.path.protected", //
				new File( new File( pathHome, "acm.cm5" ), "protected" ).getAbsolutePath() );
		Main.initProperty( "ru.myx.ae3.properties.path.private", //
				new File( new File( pathHome, "acm.cm5" ), "private" ).getAbsolutePath() );
		Main.initProperty( "ru.myx.ae3.properties.path.shared", //
